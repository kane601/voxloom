# Contributing to VoxLoom

Thank you for your interest in contributing to VoxLoom! This document provides guidelines and instructions for contributing.
...
```bash
git clone https://github.com/YOUR_USERNAME/voxloom.git
cd voxloom
...
This builds the CPU sidecar (bundled with the app), the CUDA binary (placed in `%APPDATA%/sh.voxloom.app/backends/` for runtime GPU switching), and the installable Tauri app.
...
Thank you for contributing to VoxLoom! 🎉
