        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2.5">
            <Image
              ...
              className="h-7 w-7"
            />
            <span className="text-[15px] font-semibold text-foreground">VoxLoom</span>
          </Link>
          <Link
            href="/"
            ...
            {triggered ? (
              <>
                ...
                <p className="text-lg text-muted-foreground">
                  {activeMeta
                    ? `Downloading VoxLoom for ${activeMeta.label} (${activeMeta.description}). Check your downloads folder.`
                    : 'Check your downloads folder for VoxLoom.'}
                </p>
              </>
            ) : (
              <>
                <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-foreground mb-4">
                  {linksError ? "We couldn't load the latest release." : 'Download VoxLoom'}
                </h1>
                <p className="text-lg text-muted-foreground">
                  {linksError
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Get familiar with VoxLoom — setup, voice cloning, the REST API.
              </p>
            </a>
            <a
            ...
            >
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                DeepWiki is an AI that knows VoxLoom inside-out. Ask anything.
              </p>
            </a>
            <a
              href={GITHUB_REPO}
