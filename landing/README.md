# VoxLoom Landing Page

Landing page for aispanvok.com - a modern Next.js 16 application.
...
5. Configure custom domain `aispanvok.com` in Railway settings
