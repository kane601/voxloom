...
description: "Set up your local development environment for VoxLoom"
---
...
| `just build-server-cuda` | **Windows:** CUDA server binary only, placed in `%APPDATA%/sh.voxloom.app/backends/cuda` for local testing |
