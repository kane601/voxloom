...
The [`docs/PROJECT_STATUS.md`](https://github.com/kane601/voxloom/blob/main/docs/PROJECT_STATUS.md) file is the canonical, living list of candidates under evaluation — including why some have been backlogged (e.g. VoxCPM, which is effectively CUDA-only upstream).
