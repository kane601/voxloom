...
4. **Checked [`docs/PROJECT_STATUS.md`](https://github.com/kane601/voxloom/blob/main/docs/PROJECT_STATUS.md)** — the living engineering roadmap that tracks prioritized tasks (Tier 1 → 3), architectural bottlenecks, and candidate TTS engines under evaluation (including why some are backlogged)
...
- Check [existing issues](https://github.com/kane601/voxloom/issues) for bugs
- Test your fix thoroughly
- Add regression tests if possible

### New Features

- Check [`docs/PROJECT_STATUS.md`](https://github.com/kane601/voxloom/blob/main/docs/PROJECT_STATUS.md) and the [roadmap](https://github.com/kane601/voxloom#roadmap) before proposing work — the status doc lists prioritized tasks (Tier 1 → 3), known architectural bottlenecks, and candidate TTS engines already under evaluation (including why some have been backlogged)
...
- [CHANGELOG.md](https://github.com/kane601/voxloom/blob/main/CHANGELOG.md)
...
2. Read [`docs/PROJECT_STATUS.md`](https://github.com/kane601/voxloom/blob/main/docs/PROJECT_STATUS.md) for current engineering priorities
3. Search [existing issues](https://github.com/kane601/voxloom/issues)
4. Open a new issue or discussion
5. See [CONTRIBUTING.md](https://github.com/kane601/voxloom/blob/main/CONTRIBUTING.md) in the repo
