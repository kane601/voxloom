...
```json
{
  "plugins": {
    "updater": {
      ...
      "dialog": false,
      "endpoints": [
        "https://github.com/kane601/voxloom/releases/latest/download/latest.json"
      ],
...
```json
{
  ...
  "platforms": {
    "darwin-aarch64": {
      ...
      "url": "https://github.com/kane601/voxloom/releases/download/v0.2.0/voxloom_0.2.0_aarch64.app.tar.gz"
    },
    "darwin-x86_64": {
      "signature": "base64_encoded_signature",
      "url": "https://github.com/kane601/voxloom/releases/download/v0.2.0/voxloom_0.2.0_x64.app.tar.gz"
    },
    "linux-x86_64": {
      "signature": "base64_encoded_signature",
      "url": "https://github.com/kane601/voxloom/releases/download/v0.2.0/voxloom_0.2.0_amd64.AppImage"
    },
    "windows-x86_64": {
      "signature": "base64_encoded_signature",
      "url": "https://github.com/kane601/voxloom/releases/download/v0.2.0/voxloom_0.2.0_x64_en-US.msi"
    }
  }
}
```
