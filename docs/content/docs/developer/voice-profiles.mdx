...
description: "How voice profile management works in VoxLoom"
---

## Overview

Voice profiles are the unit of "a saved voice" in VoxLoom. As of 0.4 they support two flavors backed by the same `profiles` table:
