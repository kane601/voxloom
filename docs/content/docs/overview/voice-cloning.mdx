...
<Callout type="warn">
  Voice cloning should only be used with consent. Ensure you have permission to clone someone's voice. See the project's [SECURITY.md](https://github.com/kane601/voxloom/blob/main/SECURITY.md) and your local laws on synthetic voice content.
</Callout>
