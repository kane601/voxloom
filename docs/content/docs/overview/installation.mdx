...
<Tabs items={["Apple Silicon", "Intel"]}>
  <Tab value="Apple Silicon">
    Download: [voxloom_aarch64.app.tar.gz](https://github.com/kane601/voxloom/releases/latest/download/voxloom_aarch64.app.tar.gz)
  ...
  <Tab value="Intel">
    Download: [voxloom_x64.app.tar.gz](https://github.com/kane601/voxloom/releases/latest/download/voxloom_x64.app.tar.gz)
...
<Tabs items={["MSI Installer", "Setup Executable"]}>
  <Tab value="MSI Installer">
    Download: [voxloom_x64_en-US.msi](https://github.com/kane601/voxloom/releases/latest/download/voxloom_x64_en-US.msi)

    Double-click the MSI file and follow the installation wizard.
  </Tab>
  <Tab value="Setup Executable">
    Download: [voxloom_x64-setup.exe](https://github.com/kane601/voxloom/releases/latest/download/voxloom_x64-setup.exe)
