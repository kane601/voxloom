---
title: "Installation"
description: "Download and install VoxLoom on macOS, Windows, or Linux"
---

## Download

VoxLoom is available for macOS and Windows, with Linux builds coming soon.
...
<Tabs items={["Apple Silicon", "Intel"]}>
  <Tab value="Apple Silicon">
    Download: [voxloom_aarch64.app.tar.gz](https://github.com/jamiepine/voxloom/releases/latest/download/voxloom_aarch64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf voxloom_aarch64.app.tar.gz

    # Move to Applications
    mv VoxLoom.app /Applications/
    ```
  </Tab>
  <Tab value="Intel">
    Download: [voxloom_x64.app.tar.gz](https://github.com/jamiepine/voxloom/releases/latest/download/voxloom_x64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf voxloom_x64.app.tar.gz
...
<Tabs items={["MSI Installer", "Setup Executable"]}>
  <Tab value="MSI Installer">
    Download: [voxloom_x64_en-US.msi](https://github.com/jamiepine/voxloom/releases/latest/download/voxloom_x64_en-US.msi)

    Double-click the MSI file and follow the installation wizard.
  </Tab>
  <Tab value="Setup Executable">
    Download: [voxloom_x64-setup.exe](https://github.com/jamiepine/voxloom/releases/latest/download/voxloom_x64-setup.exe)
...
When you launch VoxLoom for the first time:
...
2. **Data Directory** — Voice profiles and generated audio are stored in:
   - macOS: `~/Library/Application Support/sh.voxloom.app/`
   - Windows: `%APPDATA%/sh.voxloom.app/`
   - Linux: `~/.config/sh.voxloom.app/`
