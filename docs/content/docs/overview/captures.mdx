...
how VoxLoom strips Whisper loop hallucinations *before* the LLM sees the
...
The original audio is kept alongside the transcript in your VoxLoom data
...
[Remote Mode](/overview/remote-mode) for running VoxLoom as a server the rest
