---
title: "Quick Start"
description: "Get started with VoxLoom in 5 minutes"
---
...
Make sure you have [installed VoxLoom](/overview/installation) and launched the app.

## Step 1: Create a Voice Profile

Voice profiles are the foundation of VoxLoom. Each profile contains voice samples that the AI uses to clone the voice.
...
<Steps>
  ...
  <Step title="Enter Text">
    ...
    ```
    Hello! This is my first voice generation with VoxLoom.
    ```
...
<Cards>
  ...
  <Card title="API Integration" href="/api-reference">
    Integrate VoxLoom into your own applications
  </Card>
