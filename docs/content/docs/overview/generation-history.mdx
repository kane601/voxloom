...
VoxLoom keeps a complete history of all generated audio, making it easy to find, reuse, and manage your creations.
...
- **macOS**: `~/Library/Application Support/sh.voxloom.app/data/`
- **Windows**: `%APPDATA%/sh.voxloom.app/data/`
- **Linux**: `~/.config/sh.voxloom.app/data/`
